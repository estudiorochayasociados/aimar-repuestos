...
<head> 
	...
	<title>Revendedores - Aimar Repuestos</title>
</head>
<body>
	<div id="page">
		<header class="header">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-xs-12">
						<div class="mb-20">
							<b>Si tenes un negocio de venta de repuestos o si te interesa comenzar con uno dejanos tus datos para que alguien de nuestro equipo de ventas se ponga en contacto con vos.</b>
						</div>
						<script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/shell.js"></script>
						<script>
							hbspt.forms.create({
								portalId: "4788560",
								formId: "920718b0-8754-4224-bc3c-33a4c3b7fa97"
							});
						</script>
					</div>
					<div class="col-lg-6 col-xs-12">
